...
public:
	...
	//other
	static bool alignWithGoal(RobotDrive *drive, VictorSP *launch1, VictorSP *launch2, VictorSP *winch, VictorSP *otherWinch, std::shared_ptr<NetworkTable> table, Timer *timer);
